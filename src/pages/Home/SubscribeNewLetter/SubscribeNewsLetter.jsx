...
const SubscribeNewsletter = () => {
    ...
    return (
        <div className=" flex flex-col md:flex-row justify-between bg-purple-200 items-center p-12 border-4 rounded-lg border-purple-400 my-6">
            ...
            <div >
                <form onSubmit={handleSubmit} className="items-center gap-4">
                    ...
                    <div className="join">
                        ...
                        <button type="submit" className="btn btn-primary join-item w-1/3 sm:w-auto px-6 py-3 bg-purple-700 text-white font-semibold rounded hover:bg-purple-800 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50">Subscribe</button>
                    </div>
                </form>
            </div>
        </div>
